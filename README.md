...
<h3 align="center">Software Engineer with a construction and operations background, based in Nashville, TN</h3>
...
<table align="center">
  <tr>
    <td align="center" width="33%"><strong>Curation over abundance</strong><br><br>As content becomes cheap to produce, the real value shifts to the people and systems that can surface what is genuinely worth attention.</td>
    <td align="center" width="33%"><strong>Meet people where they are</strong><br><br>The best automation enters tools people already use and extends behaviors they already enjoy — no forced upskilling, no new identities required.</td>
    <td align="center" width="33%"><strong>Play teaches faster than obligation</strong><br><br>Games, media, and shared events can teach language, strategy, and empathy through momentum. Everyone gets there on their own schedule.</td>
  </tr>
</table>
...
<p color="white" align="center">
	...
	<!-- Docker --> <img src="https://icongr.am/devicon/docker-original-wordmark.svg?size=128&color=currentColor" alt="docker" width="70" height="70" style="max-width: 100%;">
